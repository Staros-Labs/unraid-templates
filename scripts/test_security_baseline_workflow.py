...
class SecurityBaselineWorkflowTests(unittest.TestCase):
    def test_caller_uses_pinned_ghas_free_scanners(self) -> None:
        ...
        self.assertIn("Staros-Labs/infra/.github/workflows/reusable-security-gitleaks.yml@07dce02accd706afbcb8a8b420de0979d3f03364", text)
        self.assertIn("Staros-Labs/infra/.github/workflows/reusable-security-osv.yml@07dce02accd706afbcb8a8b420de0979d3f03364", text)
